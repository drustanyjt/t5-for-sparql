...
def main():
  ...
  # vocab_path = Path(__file__).parent / 'pipeline' / 'baselines' / 'vocab.json'
  # with open(vocab_path) as f:
  #   token_dict = json.load(f)
  #   custom_tokens = token_dict.values()
  # SPECIAL_TOKENS = [t for t in custom_tokens]
  ...
  model = LongT5ForConditionalGeneration \
    .from_pretrained("google/long-t5-tglobal-base").to("cuda")
